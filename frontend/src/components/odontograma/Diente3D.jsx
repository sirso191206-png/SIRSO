...
// evaluarPieza vive ahora en estadoClinico.js (lógica clínica pura,
// sin geometría). Se importa normal (no re-exportar con "export..from",
// que NO trae el nombre al alcance local — este archivo también la usa
// internamente más abajo) y se reexporta aparte, por compatibilidad,
// para no romper a quien todavía la importa desde este archivo.
...
// varias caras con distinto estado — ver estadoClinico.js. (Definición
// movida ahí; se reexporta arriba por compatibilidad.)
