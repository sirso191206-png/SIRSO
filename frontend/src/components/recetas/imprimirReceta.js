    ...
    <head>
      ...
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .medicamento { margin-bottom: 14px; padding-left: 12px; border-left: 3px solid #D1D5DB; }
        ...
        .indicaciones-generales { margin-top: 14px; font-size: 12.5px; color: #374151; }
        .signos-vitales { margin-top: 14px; padding: 8px 12px; border: 1.5px solid #D1D5DB; border-radius: 6px; }
