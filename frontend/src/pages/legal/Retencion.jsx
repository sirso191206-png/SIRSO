  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-12 sm:px-10">
        <h1 className="mb-6 text-2xl font-semibold text-slate-800">Política de Conservación de Información</h1>
        <div className="rounded-xl border border-slate-200 bg-white p-6">
          <VisorDocumentoLegal tipo="retention" />
        </div>
        <EditorDocumentoLegal tipo="retention" />
      </main>
      <FooterPublico />
    </div>
  )
